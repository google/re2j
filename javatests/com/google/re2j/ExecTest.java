...
public class ExecTest {
  ...
  public static class DFA extends ExecTestBase {
    public DFA() {
      super(RUN_WITH_DFA);
    }
  }

  public static class NFA extends ExecTestBase {
    public NFA() {
      super(RUN_WITH_NFA);
    }
  }

  public static abstract class ExecTestBase extends OptionsTest {

    protected ExecTestBase(Options options) {
      super(options);
    }

    @Test
    public void testExamplesInDocumentation() throws PatternSyntaxException {
      RE2 re = RE2.compile("(?i:co(.)a)", options);
    ...
    public void testRE2(String file) throws IOException {
      ...
      while ((line = r.readLine()) != null) {
        ...
        if ('A' <= first && first <= 'Z') {
          ...
          String full = "\\A(?:" + q + ")\\z";
          try {
            refull = RE2.compile(full, options);
          } catch (Throwable e) {  // (handle compiler panic too)
    ...
    private final RE2 NOTAB = RE2.compilePOSIX("[^\t]+", options);
    ...
    private void testFowler(String file) throws IOException {
      ...
      while ((line = r.readLine()) != null) {
        ...
        for (char c : flag.toCharArray()) {
          ...
          RE2 re = null;
          try {
            re = RE2.compileImpl(pattern, flags, LONGEST_MATCH, options);
