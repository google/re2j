...
public class RE2ReplaceTest {
  ...
  public static class DFA extends RE2ReplaceTestBase {
    public DFA(String pattern, String replacement, String source, String expected, String replaceFirst) {
      super(pattern, replacement, source, expected, replaceFirst, RUN_WITH_DFA);
    }
  }

  public static class NFA extends RE2ReplaceTestBase {
    public NFA(String pattern, String replacement, String source, String expected, String replaceFirst) {
      super(pattern, replacement, source, expected, replaceFirst, RUN_WITH_NFA);
    }
  }
  ...
  public static abstract class RE2ReplaceTestBase extends OptionsTest {
    ...
    protected RE2ReplaceTestBase(String pattern, String replacement, String source, String expected, String replaceFirst, Options options) {
      super(options);
    ...
    public void replaceTestHelper() {
      ...
      String actual = replaceFirst
          ? re.replaceFirst(utf8Slice(source), utf8Slice(replacement)).toStringUtf8()
